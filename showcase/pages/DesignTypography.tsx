...
const FontSizeDemo: React.FC<{
  ...
  <div className="flex items-baseline py-4 border-b border-gray-200 last:border-0">
    <div className="w-24 text-sm text-gray-400 font-mono">{size}px</div>
    <div className="w-24 text-sm text-gray-500">{name}</div>
    <div className="flex-1 text-gray-900" style={{ fontSize: size }}>
      观数浏览器扩展 GuanShu
    </div>
...
const FontWeightDemo: React.FC<{
  ...
  <div className="flex items-baseline py-4 border-b border-gray-200 last:border-0">
    <div className="w-24 text-sm text-gray-400 font-mono">{weight}</div>
    <div className="w-24 text-sm text-gray-500">{name}</div>
    <div className="flex-1 text-base text-gray-900" style={{ fontWeight: weight }}>
...
export const DesignTypography: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="text-3xl font-bold text-gray-900 mb-3">字体规范</h1>
      ...
      <div className="mb-10 p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
        <h3 className="text-base font-semibold text-gray-900 mb-3">字体族</h3>
      ...
      {/* 字号 */}
      <div className="mb-10">
        <h3 className="text-lg font-semibold text-gray-900 mb-5">字号 Font Size</h3>
      ...
      {/* 字重 */}
      <div className="mb-10">
        <h3 className="text-lg font-semibold text-gray-900 mb-5">字重 Font Weight</h3>
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          {fontWeights.map((f) => (
      ...
      <div className="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <div className="text-sm text-gray-500 space-y-3">
          <p>
            <span className="text-gray-700 font-medium">Less 变量:</span>{' '}
            <code className="bg-gray-100 text-accent-600 px-2 py-1 rounded font-mono text-xs">@font-size-base</code>,{' '}
            <code className="bg-gray-100 text-accent-600 px-2 py-1 rounded font-mono text-xs">@font-weight-medium</code>
          </p>
        </div>
      </div>
    </div>
